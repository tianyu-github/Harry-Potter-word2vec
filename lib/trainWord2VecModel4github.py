...
def submitJobs (path2TextFiles , file2savePath, modelName2save, doBigram, bigramPath, minCountOfWord, dimensionOfVec, workernum):
	...
	model = gensim.models.Word2Vec(sentences,min_count=minCountOfWord,size=dimensionOfVec,max_vocab_size=120000000,workers=workernum,window=3)
...
if len(sys.argv)<7:
	...
	submitJobs ( sys.argv[1], sys.argv[2], sys.argv[3], int(sys.argv[4]), sys.argv[5] , int(sys.argv[6]), int(sys.argv[7]), int(sys.argv[8]) ) 
